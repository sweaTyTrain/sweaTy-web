...
from .views import index,second,video_feed,test,desert, mountain, island
...
urlpatterns = [
    ...
    path('mountain/', mountain, name='mountain'),   #산 월드 url
    path('island/', island, name='island'),   #섬 월드 url
