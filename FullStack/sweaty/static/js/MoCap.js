...
const tilesBaseColor = textureLoader.load(
  "../../static/img/Metal_Tiles_003_basecolor.jpg"
);
const tilesNormalMap = textureLoader.load(
  "../../static/img/Metal_Tiles_003_normal.jpg"
);
const tilesHeightMap = textureLoader.load(
  "../../static/img/Metal_Tiles_003_height.png"
);
const tilesRoughnessMap = textureLoader.load(
  "../../static/img/Metal_Tiles_003_roughness.jpg"
);
const tilesAmbientOcclusionMap = textureLoader.load(
  "../../static/img/Metal_Tiles_003_ambientOcclusion.jpg"
);
const tilesMetallicMap = textureLoader.load(
  "../../static/img/Metal_Tiles_003_metallic.jpg"
);
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        receivedDataElement3.innerHTML =
          "SquatAccu: " + String(parseFloat(jsonAccuracy) * 100) + "%"; // HTML
